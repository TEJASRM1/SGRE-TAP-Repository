            ...
            using (var scope = host.Services.CreateScope())
            {
                ...
                try
                {
                    ...
                    var roleManager = services.GetRequiredService<RoleManager<IdentityRole>>();
                     Seeds.DefaultRoles.SeedAsync(userManager, roleManager);
                     Seeds.DefaultUsers.SeedBasicUserAsync(userManager, roleManager);
                     Seeds.DefaultUsers.SeedSuperAdminAsync(userManager, roleManager);
